/** This was extracted from https://github.com/preshing/cpp11-on-multicore and modified to put the contents in the audio_io implementation namespace.

We need a semaphore that maps directly to the OS primitive because the audio thread must never ever ever ever block. Original license of this code when I extracted it is as follows:
